...
async function run(): Promise<void> {
  try {
    // Add notice
    core.warning('Thank you for using upload-cloud-storage Action. GoogleCloudPlatform/github-actions/upload-cloud-storage has been deprecated, please switch to google-github-actions/upload-cloud-storage.');
