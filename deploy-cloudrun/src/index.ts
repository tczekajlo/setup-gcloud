...
async function run(): Promise<void> {
  try {
    // Add notice
    core.warning('Thank you for using deploy-cloudrun Action. GoogleCloudPlatform/github-actions/deploy-cloudrun has been deprecated, please switch to google-github-actions/deploy-cloudrun.');
    // Get inputs
