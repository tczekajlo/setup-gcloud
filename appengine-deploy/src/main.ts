...
async function run(): Promise<void> {
  try {
    // Add notice
    core.warning('Thank you for using appengine-deploy Action. GoogleCloudPlatform/github-actions/appengine-deploy has been deprecated, please switch to google-github-actions/appengine-deploy.');
    // Get action inputs.
