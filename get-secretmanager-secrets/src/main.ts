...
async function run(): Promise<void> {
  try {
    // Add notice
    core.warning('Thank you for using get-secretmanager-secrets Action. GoogleCloudPlatform/github-actions/get-secretmanager-secrets has been deprecated, please switch to google-github-actions/get-secretmanager-secrets.');
